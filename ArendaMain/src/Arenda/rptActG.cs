...
namespace Arenda {
    ...
    public class rptActG : ReportClass {
    ...
    public class CachedrptActG : Component, ICachedReport {
        
        public CachedrptActG() {
        }
