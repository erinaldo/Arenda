...
namespace Arenda.AddNewDocToFolder
{
    public partial class frmAddDoc : Form
    {
        ...
        {
            dtScan = net.GetFileToFolde(id_Doc);
        ...
        private void addFile(string name)
        {
            ...
            if (fileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show(TempData.centralText($"Сохраняемый файл подписи не\nсоответствует требованиям:\nВысота:{height}\nШирина:{width}\nСохранение невозможно!\n"), "Сохранение подписи", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }

                saveFileToDataBase(byteFile, name, @Extension, 11, DateTime.Now);
            }
        }
