...
public class NetworkShare : IDisposable
{
    ...
    public string ConnectToShareWithPath(string server)
    {
        //Create netresource and point it at the share
    ...
    public byte[] GetFileWithPathBytes(string id_doc, string nameFile, string ext, string path)
    {
        byte[] file = null;
        ConnectToShareWithPath(path.Replace("\\" + id_doc, ""));
