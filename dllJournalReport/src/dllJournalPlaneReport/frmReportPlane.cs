...
{
    public partial class frmReportPlane : Form
    {
        ...
        private void getData()
        {
            ...
            Task<DataTable> task = Config.hCntMain.getTPlanReport(_startDate.Date, _endDate.Date);
            task.Wait();
        ...
        {
            if (DialogResult.OK == new frmAddReportPlane().ShowDialog()) getData();
        }
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            if (dgvData.CurrentRow != null && dgvData.CurrentRow.Index != -1 && dtData != null && dtData.DefaultView.Count != 0)
            {
                ...
                if (DialogResult.OK == new frmAddReportPlane() { id = id, row = row }.ShowDialog())
                    getData();
            }
        }
