...
namespace dllJournalPlaneReport
{
    class Procedures : SqlProvider
    {
        ...
        /// <param name=""></param>
        /// <returns>Таблица с данными</returns>        
        public async Task<DataTable> getMonthReport(DateTime dateStart, int id_ObjectLease,int id_tMonthPlane)
        {
            ap.Clear();
            ap.Add(dateStart);
            ap.Add(id_ObjectLease);
            ...
            return executeProcedure("[Arenda].[spg_getMonthReport]",
                 new string[3] { "@dateStart", "@id_ObjectLease", "@id_tMonthPlane" },
